...
const PROVIDER_VISUALS = {
  ...
  anthropic: {
    iconSrc: "/logos/ai/anthropic.webp",
    fallbackLabel: "A",
    accentFrom: "24 91% 63%",
    accentTo: "10 92% 61%",
    glow: "18 100% 71%",
  ...
  deepseek: {
    iconSrc: "/logos/ai/deepseek.webp",
    fallbackLabel: "D",
