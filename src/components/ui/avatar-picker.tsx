...
const avatars: Avatar[] = [
  {
    ...
    svg: (
      <svg
        ...
        aria-label="Avatar 1"
      >
        <mask id="avatar-picker-1" maskUnits="userSpaceOnUse" x="0" y="0" width="36" height="36">
          <rect width="36" height="36" rx="72" fill="#FFFFFF" />
        </mask>
        <g mask="url(#avatar-picker-1)">
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        height="40"
      >
        <mask id="avatar-picker-2" maskUnits="userSpaceOnUse" x="0" y="0" width="36" height="36">
          <rect width="36" height="36" rx="72" fill="#FFFFFF" />
        </mask>
        <g mask="url(#avatar-picker-2)">
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        height="40"
      >
        <mask id="avatar-picker-3" maskUnits="userSpaceOnUse" x="0" y="0" width="36" height="36">
          <rect width="36" height="36" rx="72" fill="#FFFFFF" />
        </mask>
        <g mask="url(#avatar-picker-3)">
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        height="40"
      >
        <mask id="avatar-picker-4" maskUnits="userSpaceOnUse" x="0" y="0" width="36" height="36">
          <rect width="36" height="36" rx="72" fill="#FFFFFF" />
        </mask>
        <g mask="url(#avatar-picker-4)">
...
export function AvatarPicker({
  className,
  subtitle = "Elegí una identidad visual temporal",
  ...
  return (
    <motion.div initial="initial" animate="animate" className={cn("w-full", className)}>
      <Card className="mx-auto w-full max-w-md overflow-hidden border-white/10 bg-gradient-to-b from-background to-muted/30 shadow-[0_20px_60px_rgba(0,0,0,0.2)]">
            ...
            <motion.div className="mt-6" variants={pickerVariants.container}>
              <motion.div className="flex justify-center gap-4" variants={pickerVariants.container}>
                {avatars.map((avatar) => (
                  ...
                  >
                    <div className="flex h-full w-full items-center justify-center">{avatar.svg}</div>
