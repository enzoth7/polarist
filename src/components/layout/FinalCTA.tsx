...
export const FinalCTA = ({
  ...
  return (
    <section className="relative z-30 flex w-full flex-col items-center justify-start px-6 pb-48 pt-16 md:pb-64 md:pt-24" style={{ background: 'var(--polarist-black, #010101)' }}>
